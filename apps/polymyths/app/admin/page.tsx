export default function PolymythsAdminPage() {
  return (
    <main style={{ minHeight: "100vh", padding: "96px 24px", color: "#e9efff", background: "#0a0a1a" }}>
      <h1>Polymyths Admin</h1>
      <p style={{ color: "rgba(233,239,255,0.7)" }}>
        Shared admin dashboard for Polymyths prediction and thesis engine management.
      </p>
      <div style={{
        marginTop: "2rem",
        padding: "1.5rem",
        ...
        <ul style={{ color: "rgba(233,239,255,0.7)", lineHeight: 2 }}>
          ...
          <li>Thesis Moderation</li>
          <li>Prediction Approval</li>
